...
# Open in browser:
# S3: [https://s3.console.aws.amazon.com/s3/buckets/my-intelligent-scaling-data-bucket](https://s3.console.aws.amazon.com/s3/buckets/my-intelligent-scaling-data-bucket)
# Lambda: [https://console.aws.amazon.com/lambda/home?region=ap-south-1#/functions](https://console.aws.amazon.com/lambda/home?region=ap-south-1#/functions)
# EventBridge: [https://console.aws.amazon.com/events/home?region=ap-south-1#/rules](https://console.aws.amazon.com/events/home?region=ap-south-1#/rules)

15-Minute Demo Flow
Minutes 0-5: ML Model
Bash

python "ML training scripts/train_model_advanced.py"  # Show full evaluation
# After training completes, evaluate:
python "ML training scripts/evaluate_advanced.py"

cat "Data Files/evaluation_results.json" | python -m json.tool  # Show metrics
...
Of course, here is the complete updated content for the Documentation/QUICK_DEMO_COMMANDS.md file. You can copy and paste this directly.
...
python "ML training scripts/evaluate_advanced.py"  # Show full evaluation
cat "Data Files/evaluation_results.json" | python -m json.tool  # Show metrics
Minutes 5-10: AWS Infrastructure
Bash
...
Open Documentation/PROFESSOR_DEMONSTRATION.md
...
[ ] Check "Data Files/evaluation_results.json" exists

[ ] Verify S3 bucket has 3 files (data, model, calendar)

[ ] Confirm Lambda functions deployed

[ ] Have Documentation/PROFESSOR_DEMONSTRATION.md open
